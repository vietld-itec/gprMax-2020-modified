...
.. code-block:: bash
    ...
    $ conda update conda
    $ conda install git
    $ git clone https://github.com/vietld-itec/gpr-Max-2020-modified
    $ cd gprMax-2020-modified
...
* Download and install `Microsoft Visual C++ 2015 Build Tools <BuildTools_Full.exe>`_ (currently you must use the 2015 version, not 2017). Use the custom installation option and deselect everything apart from the Windows SDK for your version of Windows.
